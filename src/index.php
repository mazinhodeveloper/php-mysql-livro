...
<head>
    ...
    <title>PHP and MySQL - Book</title>
    <link rel="canonical" href="https://getbootstrap.com/docs/5.3/examples/starter-template/">
    <script src="https://getbootstrap.com/docs/5.3/assets/js/color-modes.js"></script>
    <link href="https://getbootstrap.com/docs/5.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-sRIl4kxILFvY47J16cr9ZwB07vP4J8+LH7qKQnuqkuIAvNWLzeN8tE5YBujZqJLB">
...
<body>
  ...
  <div class="col-lg-8 mx-auto p-4 py-md-5"> 
    <header class="d-flex align-items-center pb-3 mb-5 border-bottom"> 
      <h1>
        <a href="/" class="d-flex align-items-center text-body-emphasis text-decoration-none"> 
          <span class="fs-4">Construindo Aplicações Web com PHP e MySQL</span> 
        </a> 
      </h1>
    </header> 
    ...
    <main> 
      ...
      <div class="row g-5"> 
        <div class="col-md-12"> 
          <h2 class="text-body-emphasis">Database Connection</h2> 
          <p>
            <?php
              try {
    ...
    <footer class="pt-5 my-5 text-body-secondary border-top">
      Created by Edmar Inocencio &middot; &copy; 2026 
    </footer> 
  </div>
